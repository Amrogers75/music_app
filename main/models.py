...
class Tracks(models.Model):  
    track_id = models.IntegerField(primary_key=True, blank=True)
    album = models.ForeignKey('main.Albums', null=True, blank=True)
    genre = models.ForeignKey('main.Genres', null=True, blank=True)
