    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album_information', models.CharField(max_length=255, null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='Tracks',
            fields=[
                ('track_id', models.IntegerField(serialize=False, primary_key=True, blank=True)),
                ...
                ('album', models.ForeignKey(blank=True, to='main.Albums', null=True)),
                ('genre', models.ForeignKey(blank=True, to='main.Genres', null=True)),
            ],
        ),
        migrations.AddField(
            model_name='albums',
